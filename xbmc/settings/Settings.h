...
public:
  ...
  // MrMC services settings
  static constexpr auto SETTING_GENERAL_SERVER_TYPE = "general.servertype";
  static constexpr auto SETTING_GENERAL_SERVER_UUID = "general.serveruuid";
  static constexpr auto SETTING_SERVICES_EMBYACESSTOKEN = "emby.accesstoken";
  static constexpr auto SETTING_SERVICES_EMBYLIMITHOMETO = "emby.limithometo";
  static constexpr auto SETTING_SERVICES_EMBYSAVEDSOURCES = "emby.savedsources";
  static constexpr auto SETTING_SERVICES_EMBYSERVERSOURCES = "emby.serversources";
  static constexpr auto SETTING_SERVICES_EMBYSERVERURL = "emby.serverurl";
  static constexpr auto SETTING_SERVICES_EMBYSIGNIN = "emby.signin";
  static constexpr auto SETTING_SERVICES_EMBYSIGNINPIN = "emby.signinpin";
  static constexpr auto SETTING_SERVICES_EMBYUSERID = "emby.userid";
  static constexpr auto SETTING_SERVICES_HUE_CLIENTKEY = "hue.clientkey";
  static constexpr auto SETTING_SERVICES_HUE_COLORBIAS = "hue.colorbias";
  static constexpr auto SETTING_SERVICES_HUE_CONTINUOUS = "hue.continuous";
  static constexpr auto SETTING_SERVICES_HUE_DIMBRIGHT = "hue.dimbright";
  static constexpr auto SETTING_SERVICES_HUE_DIMDUR = "hue.dimdur";
  static constexpr auto SETTING_SERVICES_HUE_DIMMODE = "hue.dimmode";
  static constexpr auto SETTING_SERVICES_HUE_DIMOVERPAUSEDBRIGHT = "hue.dimoverpausedbright";
  static constexpr auto SETTING_SERVICES_HUE_DIMOVERUNBRIGHT = "hue.dimoverunbright";
  static constexpr auto SETTING_SERVICES_HUE_DIMPAUSEDBRIGHT = "hue.dimpausedbright";
  static constexpr auto SETTING_SERVICES_HUE_DIMPAUSEDSCENE = "hue.dimpausedscene";
  static constexpr auto SETTING_SERVICES_HUE_DIMSCENE = "hue.dimscene";
  static constexpr auto SETTING_SERVICES_HUE_DIMSTOPPEDSCENE = "hue.dimstoppedscene";
  static constexpr auto SETTING_SERVICES_HUE_DIMUNBRIGHT = "hue.dimunbright";
  static constexpr auto SETTING_SERVICES_HUE_DISCOVER = "hue.discover";
  static constexpr auto SETTING_SERVICES_HUE_ENABLE = "services.hue";
  static constexpr auto SETTING_SERVICES_HUE_FORCEON = "hue.forceon";
  static constexpr auto SETTING_SERVICES_HUE_FORCEONAFTERSUNSET = "hue.forceonaftersunset";
  static constexpr auto SETTING_SERVICES_HUE_IP = "hue.ip";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT1ID = "hue.light1";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT1MODE = "hue.light1mode";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT2ID = "hue.light2";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT2MODE = "hue.light2mode";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT3ID = "hue.light3";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT3MODE = "hue.light3mode";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT4ID = "hue.light4";
  static constexpr auto SETTING_SERVICES_HUE_LIGHT4MODE = "hue.light4mode";
  static constexpr auto SETTING_SERVICES_HUE_MAXBRIGHT = "hue.maxbright";
  static constexpr auto SETTING_SERVICES_HUE_MINBRIGHT = "hue.minbright";
  static constexpr auto SETTING_SERVICES_HUE_STREAMGROUPID = "hue.streamgroup";
  static constexpr auto SETTING_SERVICES_HUE_USERNAME = "hue.username";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSENABLE = "services.lighteffects";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSINTERPOLATION = "services.lighteffectsinterpolation";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSIP = "services.lighteffectsip";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSPORT = "services.lighteffectsport";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSATURATION = "services.lighteffectssaturation";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSPEED = "services.lighteffectsspeed";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSTATICB = "services.lighteffectsstaticb";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSTATICG = "services.lighteffectsstaticg";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSTATICON = "services.lighteffectsstaticon";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSTATICR = "services.lighteffectsstaticr";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSSTATICSCREENSAVER = "services.lighteffectsstaticscreensaver";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSTHRESHOLD = "services.lighteffectsthreshold";
  static constexpr auto SETTING_SERVICES_LIGHTEFFECTSVALUE = "services.lighteffectsvalue";
  static constexpr auto SETTING_SERVICES_PLEXGDMSERVER = "plex.gdmserver";
  static constexpr auto SETTING_SERVICES_PLEXHOMEUSER = "plex.homeuser";
  static constexpr auto SETTING_SERVICES_PLEXHOMEUSERTHUMB = "plex.homeuserthumb";
  static constexpr auto SETTING_SERVICES_PLEXLIMITHOMETO = "plex.limithometo";
  static constexpr auto SETTING_SERVICES_PLEXMYPLEXAUTH = "plex.myplexauthtoken";
  static constexpr auto SETTING_SERVICES_PLEXQUALITY = "plex.quality";
  static constexpr auto SETTING_SERVICES_PLEXSIGNIN = "plex.signin";
  static constexpr auto SETTING_SERVICES_PLEXSIGNINPIN = "plex.signinpin";
  static constexpr auto SETTING_SERVICES_PLEXTRANSCODE = "plex.transcode";
  static constexpr auto SETTING_SERVICES_PLEXTRANSCODEAUDIO = "plex.transcodeaudio";
  static constexpr auto SETTING_SERVICES_PLEXTRANSCODELOCAL = "plex.transcodelocal";
  static constexpr auto SETTING_SERVICES_PLEXTRANSCODELOCALEXCLUSION = "plex.transcodelocalexclusions";
  static constexpr auto SETTING_SERVICES_PLEXTRANSCODELOCALEXCLUSIONHEVC = "plex.transcodelocalexclusionshevc";
  static constexpr auto SETTING_SERVICES_PLEXUPDATEMINS = "plex.updatetime";
  static constexpr auto SETTING_SERVICES_TRAKTACESSREFRESHTOKEN = "trakt.accessrefreshtoken";
  static constexpr auto SETTING_SERVICES_TRAKTACESSTOKEN = "trakt.accesstoken";
  static constexpr auto SETTING_SERVICES_TRAKTACESSTOKENVALIDITY = "trakt.accesstokenvalidity";
  static constexpr auto SETTING_SERVICES_TRAKTACTIONAFTERLIBRARYUPDATE = "trakt.actionafterlibraryupdate";
