...
private:
  ...
  mutable CCriticalSection m_criticalMovies;
  mutable CCriticalSection m_criticalTVShow;
  mutable CCriticalSection m_criticalArtist;
  mutable CCriticalSection m_criticalPhoto;
  mutable CCriticalSection m_criticalPlaylist;
  mutable CCriticalSection m_criticalHome;
