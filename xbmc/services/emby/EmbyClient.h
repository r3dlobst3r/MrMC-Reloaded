...
private:
  ...
  mutable CCriticalSection m_viewMoviesFilterLock;
  mutable CCriticalSection m_viewTVShowsFilterLock;

  mutable CCriticalSection m_topViewIDsLock;
  mutable CCriticalSection m_viewMusicLock;
  mutable CCriticalSection m_viewMoviesLock;
  mutable CCriticalSection m_viewPhotosLock;
  mutable CCriticalSection m_viewTVShowsLock;
